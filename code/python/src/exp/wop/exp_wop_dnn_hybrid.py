...
def create_dnn_branch(input_source: str, pretrained_embedding_models,
    ...
    if input_source == 'name':
        ...
        return dnn_classifier.create_dnn_branch(
            ...
            input_text_sentence_length=col_text_length,
            input_text_word_embedding_dim=util.DNN_EMBEDDING_DIM,
            model_descriptor="cnn[2,3,4](conv1d=100)|maxpooling1d=4|flatten|dense=?-softmax|glv",
            embedding_trainable=False,
        ...
        return dnn_classifier.create_dnn_branch(
            ...
            input_text_sentence_length=col_text_length,
            input_text_word_embedding_dim=util.DNN_EMBEDDING_DIM,
            model_descriptor="bilstm=100-False|dense=?-softmax|glv",
            embedding_trainable=False,
            embedding_mask_zero=True
        )
...
if __name__ == "__main__":
    ...
    for setting_file in os.listdir(sys.argv[1]):
        ...
        # 4,name,20|5,desc,100|8-9,cat,20
        ...
        for string in input_column_sources:
            ...
            dnn_branch = create_dnn_branch(col_name,
                pretrained_embedding_models, data,
                col_text_length
            )
        ...
        dnn_classifier.fit_dnn(inputs=dnn_branch_input_features,
                               ...
                               model_descriptor=properties['training_text_data_columns'])
